...
sudo flatpak install -y com.microsoft.Teams                 # Microsoft Teams
...
sudo flatpak install -y net.waterfox.waterfox               # Waterfox
sudo flatpak install -y com.bitwarden.desktop               # Bitwarden
sudo flatpak install -y md.obsidian.Obsidian                # Obsidian
sudo flatpak install -y com.tencent.WeChat                  # WeChat
